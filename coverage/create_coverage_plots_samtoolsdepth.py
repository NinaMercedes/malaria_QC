...
for sample_name in sample_names:
  ...
  input_file = sample_name + '.bqsr.cram.samtools_windowed_depth.csv'
  output_file = sample_name + '.bqsr.cram.samtools_windowed_depth_filtered.csv'
  # Read the input file
...
subprocess.run('cat samples.txt | parallel -j 30 "python chromo_coverage.py --sample {} --csvfile {}.bqsr.cram.samtools_windowed_depth_filtered.csv" > chromocoverage.txt', shell=True)
